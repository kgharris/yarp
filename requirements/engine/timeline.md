...
| R:engine / timeline / [ member ] : ss-claiming-age | MVP | Each [S:household / [ member ]](../conceptual-model.md#s-household) who has Social Security benefits configured must have a configurable Social Security claiming age. |
...
| R:engine / timeline / [ member ] : rmd-start-age | MVP | Each [S:household / [ member ]](../conceptual-model.md#s-household) who owns a tax-deferred account subject to RMD rules must have an RMD start age derived from their birth year using [S:assumptions / policy / rmd / start-age](../conceptual-model.md#s-assumptions). |
