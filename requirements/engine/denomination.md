...
| R:engine / denomination / yzv : anchor | MVP | The plan anchor year must be fixed at plan creation and must not change as the calendar advances unless the user explicitly rebases the plan. |
